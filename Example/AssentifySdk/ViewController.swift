...
final class ViewController: UIViewController, AssentifySdkDelegate, FlowDelegate {
    ...
    private func setupLayout() {
        ...
        let guideRow = makeSwitchRow(title: "Enable Guide", toggle: guideSwitch)
        ...
        content.addArrangedSubview(guideRow)
    ...
    func onFlowCompleted(submitRequestModel: [SubmitRequestModel]) {
        DispatchQueue.main.async {
            self.showAlert(title: "Flow Completed", message: "Submit count: \(submitRequestModel.count)")
        }
    }
